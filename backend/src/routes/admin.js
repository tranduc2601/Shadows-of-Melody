...
import { getStats, getUsers, deleteUser, toggleAdmin, getArtists, revokeArtistRole, getArtistContent, getGenres, createGenre, getAlbums, createAlbum, updateUserRole } from '../controllers/adminController.js';
